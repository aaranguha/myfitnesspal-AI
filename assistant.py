        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    '  - "update_serving": change the serving size of an already-logged food '
                    '(e.g. "change khichdi to 2 servings", "update the rice to 1.5 servings", '
                    '"make the chicken 3 servings")\n'
                    ...
                    '- "servings": number or null (for update_serving — the NEW serving count, e.g. 2, 1.5)\n\n'
                    "Examples:\n"
                    ...
                    '- "change the khichdi in dinner to 2 servings" → {"meal": "dinner", "foods": "khichdi", "intent": "update_serving", "preset_name": null, "sub_action": null, "servings": 2}\n'
                    '- "update my rice to 1.5 servings" → {"meal": null, "foods": "rice", "intent": "update_serving", "preset_name": null, "sub_action": null, "servings": 1.5}\n'
                    '- "make the chicken 3 servings" → {"meal": null, "foods": "chicken", "intent": "update_serving", "preset_name": null, "sub_action": null, "servings": 3}\n'
